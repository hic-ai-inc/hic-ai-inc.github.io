# Pre-Launch Status Assessment & Action Plans v3

**Date:** February 18, 2026 (v3; supersedes v2 Feb 18, v1 Feb 16)
...
**Methodology:** Builds on v1 (Feb 16) assessment of 66 commits across 3 repos, incorporating all decisions from the Feb 17 Decision & Gap Analysis session and the Feb 18 SMP Discovery. v3 aligns all MoR framing to the confirmed SMP-first path (AP 8 AR), updates AP cross-references to v2 documents, and corrects corporate entity references.
...
- B-D1 through B-D8 deferred until after SMP integration complete (D-4, updated)
- SMP is the confirmed MoR path; LS/Paddle retained as contingency only (AP 8 AR §14)
- SWR's own paid subscription = the P8 live payment verification (dogfooding from Day 1; funds accrue to HIC AI, Inc.)
- Social media consolidated into AP 12; private disclosures remain distinct as AP 13

**Estimated total effort to launch:** ~40–60 hours of focused work, of which ~20–30 hours are on the critical path. SMP eliminates the ~1-week external MoR review wait that previously dominated the timeline. The sole remaining feature gap is the version update wire-up (AP 9, items 9.8–9.10). All other work is operational, quality assurance, or legal.
...
| **8** | Launch                         | Blocked on remaining Phase 6–7 items + SMP integration + production deployment                                                                                                                                                                                                    |
...
| 16  | Marketing Strategy               | Open                       | AP 3 — post-launch OK, prep during sprint                                                                                           |
...
| **D-4**  | B-D1–B-D8 (Track B decisions)  | Deferred until after SMP integration complete (updated) | Track A takes absolute priority; Track B resumes after SMP verification (no external wait period)     |
...
Per D-4 (updated), these are explicitly deferred until after SMP integration is complete. They gate Track B work, which resumes after SMP verification — no external wait period.
...
| ------ | ----------------------------------- | --------------------------------------- | -------------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------- |
| **0**  | Quick Wins & Initial Setup          | High — opening gate                     | ~3–3.5h              | [Standalone](20260218_AP0_QUICK_WINS_AND_INITIAL_SETUP_V2.md)                                    | Not started                                 |
| **1**  | Front-End UX & Content              | High-value, not hard gate               | 5–6h (Tier 1–2)      | [Standalone](20260218_AP1_FRONT_END_UX_PRIORITIZATION_PLAN_V2.md)                                | Not started                                 |
| **2a** | Website Surface Security Review     | Pre-launch                              | 2–3h                 | [Inline §8.1](#81-ap-2a-website-surface-security-review)                                      | Not started                                 |
...
| **4**  | Switch to Production                | **Launch blocker**                      | 4–8h                 | [Standalone](20260218_AP4_SWITCH_TO_PRODUCTION_PLAN_V2.md) — phased P0–P9 plan                   | Not started                                 |
...
| **12** | Social Media, SEO & Content Distribution | Pre-launch (Phases 1–3) + Ongoing         | 12–18h               | [Standalone](20260218_AP12_SOCIAL_MEDIA_SEO_AND_CONTENT_DISTRIBUTION_PLAN_V2.md)                 | Not started                                 |
...
| Document                                                                       | Purpose                                                                                                                                                                                          |
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Action Plan Dependency Map v2](20260218_ACTION_PLAN_DEPENDENCY_MAP_V2.md)     | v2: Phase 0 gate, two-track architecture, C1–C4 phased cutover. **v3 pending** — will compress timeline per SMP-first path. |
...
| [LS Migration Plan](20260216_PROPOSED_PLANS_FOR_LEMON_SQUEEZY_MIGRATION.md)    | Historical — LS migration feasibility (superseded by SMP path in AP 8 AR; retained as contingency documentation).                                                                                |
...
**Effort:** 2–3 hours | **Priority:** Pre-launch | **Dependencies:** AP 1 near-final (or parallel — API routes are independent of content)

Focused review of the public-facing website for production readiness. This is **not** the comprehensive audit — that's AP 2b.
...
> **Internal ordering:** 11.4 (Plausible) must happen before 11.1 (Privacy Policy) — the policy must accurately describe the analytics approach. 11.5–11.7 (IP review) best done after AP 5 (docs finalized). 11.8–11.9 (filings) have no technical dependencies but are SWR personal legal tasks — schedule when sprint timing allows.
...
**Effort:** 3–5 days elapsed (~3–5h actual) | **Priority:** Pre-launch (blocks AP 12 LinkedIn update) | **Dependencies:** SMP integration verified (SWR has certainty of launch direction)
