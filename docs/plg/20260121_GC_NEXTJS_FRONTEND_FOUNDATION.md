...
export const PRICING = {
  individual: {
    ...
    priceMonthly: 40, // List price
    launchPriceMonthly: 20, // 50% off
    seats: 1,
    maxDevices: 3,
    features: [
      "All Mouse tools",
  ...
  team: {
    ...
    priceMonthly: 50, // List price per seat
    launchPriceMonthly: 25, // 50% off
    minSeats: 2,
    maxSeats: 100,
    maxDevicesPerSeat: 2,
    features: [
...
export const STRIPE_PRODUCTS = {
  individual: {
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_INDIVIDUAL,
    launchPriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_INDIVIDUAL_LAUNCH,
  },
  team: {
    priceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_TEAM,
    launchPriceId: process.env.NEXT_PUBLIC_STRIPE_PRICE_TEAM_LAUNCH,
  },
};
...
NEXT_PUBLIC_STRIPE_PRICE_INDIVIDUAL_LAUNCH=price_...
NEXT_PUBLIC_STRIPE_PRICE_TEAM=price_...
NEXT_PUBLIC_STRIPE_PRICE_TEAM_LAUNCH=price_...
