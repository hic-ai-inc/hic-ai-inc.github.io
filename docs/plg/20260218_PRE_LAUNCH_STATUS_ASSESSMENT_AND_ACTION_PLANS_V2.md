...
| Document                                                                       | Purpose                                                                                                                                                                                          |
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Action Plan Dependency Map v2](20260218_ACTION_PLAN_DEPENDENCY_MAP_V2.md)     | v2: Phase 0 gate, two-track architecture, C1–C4 phased cutover, dual-MoR sequencing, all gap items placed, settled decisions reflected. Supersedes v1 (Feb 16). |
