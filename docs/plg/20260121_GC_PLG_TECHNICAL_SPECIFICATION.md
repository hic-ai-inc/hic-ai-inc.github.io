...
```json
{
  ...
  "plan": "INDIVIDUAL_MONTHLY | INDIVIDUAL_ANNUAL | TEAM_MONTHLY | ENTERPRISE_ANNUAL",
...
| `prod_mouse_team`       | Mouse Team       | For small teams (2-10 seats)  |
...
| -------------------------- | ---------- | -------- | ----------- | ------------------------ |
| `price_individual_monthly` | Individual | Monthly  | $40.00      | Base price               |
| `price_individual_annual`  | Individual | Annual   | $400.00     | ($40/mo × 12, ~17% off)  |
| `price_team_monthly`       | Team       | Monthly  | $50.00/seat | Base price               |
| `price_team_annual`        | Team       | Annual   | $500/seat   | ($50/mo × 12, ~17% off)  |
| `price_enterprise_annual`  | Enterprise | Annual   | $500/seat   | Min 10 seats, ~17% off   |

### 4.3 Coupons & Promotions

| Coupon ID       | Type        | Value | Duration        | Use Case                  |
| --------------- | ----------- | ----- | --------------- | ------------------------- |
| `LAUNCH50`      | Percent Off | 50%   | First 11 months | Launch promo (with trial) |
| `EARLYBIRD30`   | Percent Off | 30%   | First 3 months  | Early adopter monthly     |
| `WELCOME_TRIAL` | N/A         | N/A   | 30-day trial    | Free month intro          |
...
| `pol_team`       | Team Seat       | 2            | Subscription-linked | All features       |
